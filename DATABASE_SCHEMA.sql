-- ============================================
-- SAGEO 2026 - SCHEMA COMPLETO (IDs TEXT)
-- Cola tudo no SQL Editor do Supabase e clica RUN
-- ============================================

-- 1. Remover tabelas antigas (para começar limpo)
...
-- 2. Tabela de Eventos (ID textual)
...
-- 3. Tabela de Inscrições (IDs textuais + referência textual ao evento)
...
-- 7. Galeria de Memórias (com colunas de moderação)
